let pass_regex:RegExp = /(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}/; //passwoord
let name_regex:RegExp = /^[A-Za-z]{3,}$/  //name
let contact_regex:RegExp = /^[\d]{8,10}$/  //contact
let email_regex:RegExp = /^[a-zA-Z0-9]+@[a-z]{4,}.[a-z]{2,}(.[a-z]{2,4})?$/; //email
